...
class TSAnnotator:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new LSTM-CNN TSAnnotator.
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the LSTM TSAnnotator to disk.
    ...
    def load(cls, model_dir_path: str) -> "TSAnnotator":
        """Load the LSTM TSAnnotator from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TSAnnotator: A new instance of the loaded LSTM TSAnnotator.
        """
