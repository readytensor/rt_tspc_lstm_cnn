...
class TimeStepClassifier:
    """LSTM-CNN Timeseries Annotator.

    This class provides a consistent interface that can be used with other
    TimeStepClassifier models.
    """

    MODEL_NAME = "LSTM_CNN_Timeseries_Annotator"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Construct a new LSTM-CNN TimeStepClassifier.
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the LSTM TimeStepClassifier to disk.
    ...
    def load(cls, model_dir_path: str) -> "TimeStepClassifier":
        """Load the LSTM TimeStepClassifier from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            TimeStepClassifier: A new instance of the loaded LSTM TimeStepClassifier.
        """
